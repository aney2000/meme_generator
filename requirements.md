...
On a decent linux distro this works
```bash
magick images/original.jpeg -font Liberation-Sans -fill black -undercolor White -pointsize 60 -gravity center -draw "text 0,200 'Mornings are best'" meme.jpeg
```
